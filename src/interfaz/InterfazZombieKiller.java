...
public class InterfazZombieKiller extends JFrame implements IInterfazZombieKiller {
	 ...
	 */
	private HiloAdmin administradorHilos;
	/**
	...
	/**
	 * Panel del men� principal cualquier bot�n muestra otro panel
	 * representatitvo a �l
	 */
	...
	/**
	 * Panel que muestra las instrucciones de juego Muestra las estad�sticas de
	 * las armas
	 */
	...
	/**
	 * Panel que muestra los cr�ditos de las personas que participaron
	 */
	...
	public InterfazZombieKiller() {
		administradorHilos = new HiloAdmin();
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Hubo un error al guardar los �ltimos puntajes");
		} catch (IOException e) {
	...
	/**
	 * M�todo auxiliar que inicializa y actualiza la informaci�n en los
	...
	/**
	 * pregunta si en el PanelCamp se est�n cargando las im�genes
	 * 
	 * @return true si a�n se est�n cargando
	 */
	 ...
	 * <pre></pre>
	 * 
	 * el juego no se encuentra pausado dispara el arma principal en la posici�n
	...
	/**
	 * cambia el arma del personaje y actualiza aqu�
	 */
	...
	/**
	 * <pre>
	 * la posici�n en el eje Y est� por debajo de la que el zombie ataca
	 * </pre>
	 * 
	 * intenta acuchillar
	 * 
	...
	/**
	 * Muestra el Panel de C�mo jugar / Lo oculta
	 */
	...
	/**
	 * Muestra el Panel donde se encuentran los cr�ditos / lo oculta
	 */
	...
	/**
	 * obtiene el n�mero de referencia al arma que se muestra en el panelArmas
	 * 
	...
	/**
	 * Cambia el arma que se est� viendo por el de la derecha
	 * 
	 * @return n�mero de referencia al arma de la derecha
	 */
	...
	/**
	 * Cambia el arma que se est� viendo por el de la izquierda
	 * 
	 * @return n�mero de referencia al arma de la izquierda
	 */
	...
	/**
	 * M�todo llamado cuando el personaje muere para verificar si el jugador
	 * desea seguir o no
	 */
			...
			if (nombrePlayer != null && !nombrePlayer.equals(""))
				try {
					...
					JOptionPane.showMessageDialog(this,
							"Error al guardar el puntaje, es posible que haya abierto el juego desde \"Acceso r�pido\"");
